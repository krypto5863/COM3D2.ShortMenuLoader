...
namespace Experiment5ParallelMenuLoading
{
	...
	public class Main : BaseUnityPlugin
	{
		...
		public static ConcurrentDictionary<SceneEdit.SMenuItem, string> ListOfIconLoads = new ConcurrentDictionary<SceneEdit.SMenuItem, string>();
		public static ConcurrentQueue<SceneEdit.SMenuItem> ListOfContinues = new ConcurrentQueue<SceneEdit.SMenuItem>();
		private static bool SetupDone = false;
		private static bool IconLoadDone = false;
		//public static ConcurrentDictionary<SceneEdit.SMenuItem> test;
